...
@section('content')
    ...
    <div class="container-fluid mt--6">
                    ...
                    <div class="card-header border-0 form-inline">
                        ...
                        <div class="col-lg-6 text-right">
                            <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" id="add_btn"
                                onclick="clearForm()">Add Member</button>
                        </div>
                    </div>
                    <!-- Modal add inventory -->
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="/unit/save" method="post" name="inv_form" id="inv_form">
                                        ...
                                        <div class="form-group form-inline">
                                            <div class="col-lg-4 text-right">No. Identitas</div>
                                            <div class="col-lg-8"><input type="text" name="no_identitas" id="no_identitas"
                                                    class="form-control w-90" required></div>
                                        </div>
                                        <div class="form-group form-inline">
                                            <div class="col-lg-4 text-right">No. HP</div>
                                            <div class="col-lg-8"><input type="text" name="no_hp" id="no_hp"
                                                    class="form-control w-90" required></div>
                                        </div>
                                        <div class="form-group form-inline">
                                          <div class="col-lg-4 text-right">Tanggal Lahir</div>
                                          <div class="col-lg-8"><input type="text" name="tanggal_lahir" id="tanggal_lahir"
                                                  class="form-control w-90 datepicker" required></div>
                                      </div>
                                    </form>
                                </div>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item"
                                                        onclick="edit({{ $member->id_member }}, '{{ $member->no_member }}', '{{ $member->nama_lengkap }}', '{{ $member->no_identitas }}', '{{ $member->no_hp }}', '{{ $member->tanggal_lahir }}')"
                                                        data-id="{{ $member->id_member }}">Edit</a>
                                                    <a class="dropdown-item" href="#"
                                                        onclick="deleteMember({{ $member->id_member }})"
                                                        data-id="{{ $member->id_member }}">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
        ...
        <script>
            ...
            function edit(id, no_member, nama_lengkap, no_identitas, no_hp, tanggal_lahir) {
                $("#id_member").val(id);
            ...
            function save() {
                ...
                xhttp.open("POST", "/member/save", true);
