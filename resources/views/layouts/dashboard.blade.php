...
<body>
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        @if (Session()->get('id_role') === 2)
                            <li class="nav-item">
                                <a class="nav-link @yield('is_user_list_active')" href="/user/list">
                        ...
                        @if (Session()->get('id_role') === 2)
                            <li class="nav-item">
                                <a class="nav-link @yield('is_supplier_active')" href="/supplier">
                        ...
                        @if (Session()->get('id_role') !== 1)
                            <li class="nav-item">
                                <a class="nav-link @yield('is_member_active')" href="#" data-toggle="collapse" data-target="#member">
                                    <i class="ni ni-badge text-default"></i>
                                    <span class="nav-link-text">Member</span>
                                </a>
                                <ul class="nav-navbar collapse" id="member" style="list-style-type: none">
                                    @if (Session()->get('id_role') !== 1)
                                      <li class="nav-item">
                                        <a class="nav-link @yield('is_member_active')" href="/member">Member List</a>
                                      </li>
                                      <li class="nav-item">
                                        <a href="/member/topup" class="nav-link @yield('is_topup_member_active')">Top Up Member</a>
                                      </li>
                                    @endif
                                </ul>
                            </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link @yield('is_product_active')" href="#" data-toggle="collapse"
                                data-target="#inventory">
                                <i class="ni ni-box-2 text-info"></i>
                                <span class="nav-link-text">Inventory</span>
                            </a>
                            <ul class="nav-navbar collapse" id="inventory" style="list-style-type: none">
                              @if (Session()->get('id_role') === 2)
                                <li class="nav-item">
                                  <a class="nav-link @yield('is_product_active')" href="/inventory">Inventory > List</a>
                                </li>
                                <li class="nav-item">
                                  <a href="/unit" class="nav-link @yield('is_unit_active')">Inventory > Unit</a>
                                </li>
                                <li class="nav-item">
                                  <a href="/category" class="nav-link @yield('is_category_active')">Inventory > Category</a>
                                </li>
                                @endif
                              @if (Session()->get('id_role') === 1 || Session()->get('id_role') === 2)
                                <li class="nav-item">
                                  <a href="/stock" class="nav-link @yield('is_stock_active')">Inventory > Stock</a>
                                </li>
                              @endif
                            </ul>
                        </li>
                        ...
                        @if (Session()->get('id_role') !== 1)
                            <li class="nav-item">
                                <a class="nav-link @yield('is_transaction_active')" href="/transaction">
                        ...
                        @if (Session()->get('id_role') === 2)
                            <li class="nav-item">
                                <a class="nav-link @yield('is_report_active')" href="#" data-toggle="collapse"
                                    data-target="#submenu1">
                                    <i class="ni ni-chart-bar-32 text-dark"></i>
                                    <span class="nav-link-text">Reports</span>
                                </a>
                                <ul class="nav-item collapse" id="submenu1">
                                    <li class="nav-item">
                            ...
                            <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true"
                                ...
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body  ml-2  d-none d-lg-block">
                                        <span
                                            class="mb-0 text-sm  font-weight-bold">{{ Session()->get('username') }}</span>
                                    </div>
                                </div>
                            </a>
    ...
    <!-- Argon JS -->
    {{-- <script src="{{ URL::asset('assets/js/argon.js?v=1.2.0') }}"></script>
    --}}
</body>
