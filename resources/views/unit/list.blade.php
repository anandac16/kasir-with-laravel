                    ...
                    <div class="card-header border-0 form-inline">
                        ...
                        <div class="col-lg-6 text-right">
                            <button class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" id="add_btn"
                                onclick="clearForm()">Add Unit</button>
                        </div>
                    </div>
                    <!-- Modal add inventory -->
                                ...
                                <div class="modal-body">
                                    ...
                                    <form action="/unit/save" method="post" name="inv_form" id="inv_form">
                                        <div class="form-group form-inline">
                                            <input type="hidden" name="id_unit" id="id_unit" value="0">
                                            <div class="col-lg-4 text-right">Unit</div>
                                            <div class="col-lg-8"><input type="text" name="unit" id="unit"
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                    <a class="dropdown-item" onclick="edit({{ $unit->id_unit }}, '{{ $unit->unit }}')"
                                                        data-id="{{ $unit->id_unit }}">Edit</a>
                                                    <a class="dropdown-item" href="#"
                                                        onclick="deleteItem({{ $unit->id_unit }})"
                                                        data-id="{{ $unit->id_unit }}">Delete</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
        ...
        <script>
           ...
           function edit(id, unit) {
            ...
            function save() {
                ...
                xhttp.open("POST", "/unit/save", true);
